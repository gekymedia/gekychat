...
Route::prefix('v1')
    ...
    ->group(function () {
        ...
        Route::post('/messages/{id}/read', [MessageController::class, 'markRead'])->name('api.messages.read');
        Route::post('/messages/{id}/delivered', [MessageController::class, 'markDelivered'])->name('api.messages.delivered');
        Route::get('/messages/{id}/info', [MessageController::class, 'info'])->name('api.messages.info');
        Route::post('/messages/{id}/view-once', [MessageController::class, 'viewOnce'])->name('api.messages.view-once');

        // Broadcast relatedt('/messages/{id}/around', [MessageController::class, 'around']);
        ...
        Route::post('/calls/{session}/livekit-moderate', [CallController::class, 'livekitModerate']);
        ...
        Route::get('/world-feed/posts/by-share/{code}', [\App\Http\Controllers\Api\V1\WorldFeedController::class, 'showByShareCode']);
        Route::get('/world-feed/posts/{postId}', [\App\Http\Controllers\Api\V1\WorldFeedController::class, 'showPost'])->whereNumber('postId');
        ...
        Route::post('/world-feed/comments/{commentId}/dislike', [\App\Http\Controllers\Api\V1\WorldFeedController::class, 'dislikeComment']);
