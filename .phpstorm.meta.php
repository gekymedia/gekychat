...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Services\SmsServiceInterface' => \App\Services\ArkeselSmsService::class,
            ...
            'arkesel-sms' => \App\Services\ArkeselSmsService::class,
    ...
    override(\config(), map([
            ...
            'arkesel.api_key' => 'string',
            'arkesel.sender_id' => 'string',
            'arkesel.endpoint' => 'string',
            ...
            'filesystems.links.C:\projects\gekychat-l11\public\storage' => 'string',
...
'app.aliases.Vite','arkesel.api_key','arkesel.sender_id','arkesel.endpoint','auth.defaults.guard',
...
'filesystems.disks.s3.throw','filesystems.links.C:\\projects\\gekychat-l11\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'webpush.client_options','webpush.automatic_padding','concurrency.default','cors.paths','cors.allowed_methods',
...
'view.compiled','flare.key','flare.flare_middleware','flare.flare_middleware.Spatie\\LaravelIgnition\\FlareMiddleware\\AddLogs.maximum_number_of_collected_logs','flare.flare_middleware.Spatie\\LaravelIgnition\\FlareMiddleware\\AddQueries.maximum_number_of_collected_queries',
...
'ignition.healthCheck','ignition.executeSolution','ignition.updateConfig','login','logout','register','password.request',
'password.email','password.reset','password.update','password.confirm','send.otp','verify.otp','resend.otp',
'verify.2fa','resend.2fa','chat.index','chat.new',
'chat.start','chat.show','chat.send','chat.clear','chat.read',
'message.delete','chat.typing','push.subscribe','admin.messages','admin.message.delete',
'admin.conversations','admin.conversation.delete','offline','settings.security.show','settings.security.update',
'home','profile.edit','profile.update','groups.create','groups.store',
'groups.show','groups.messages.store','groups.members.add','groups.members.remove','groups.leave',);
        registerArgumentsSet('views', 
'admin.conversations','admin.conversations.index','admin.conversations.show','admin.messages','admin.messages.index',
'admin.messages.show','admin.users','admin.users.index','admin.users.show','auth.login',
'auth.passwords.confirm','auth.passwords.email','auth.passwords.reset','auth.phone-login','auth.register',
'auth.verify','auth.verify-otp','chat.index','chat.new','groups.create',
'groups.show','home','layouts.admin','layouts.app','profile.edit',
'settings.security','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid',
'C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.projects.gekychat-l11.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','BROADCAST_DRIVER',
'REVERB_APP_ID','REVERB_APP_KEY','REVERB_APP_SECRET','REVERB_HOST','REVERB_PORT',
'REVERB_SCHEME','REVERB_ALLOW_ORIGINS','VITE_REVERB_APP_KEY','VITE_REVERB_HOST','VITE_REVERB_PORT',
'VITE_REVERB_SCHEME','VITE_REVERB_ALLOW_ORIGINS','ARKESEL_API_KEY','ARKESEL_SENDER_ID','ARKESEL_SMS_ENDPOINT',);
