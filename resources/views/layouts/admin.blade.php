                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="{{ route('admin.bot-contacts.index') }}" 
                           class="flex items-center space-x-3 p-3 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors {{ request()->routeIs('admin.bot-contacts.*') ? 'bg-cyan-50 dark:bg-cyan-900/20 text-cyan-600 dark:text-cyan-400' : '' }}">
                            ...
                            <span class="sidebar-text font-medium">Bot Contacts</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('admin.audio.index') }}" 
                           class="flex items-center space-x-3 p-3 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-pink-50 dark:hover:bg-pink-900/20 hover:text-pink-600 dark:hover:text-pink-400 transition-colors {{ request()->routeIs('admin.audio.*') ? 'bg-pink-50 dark:bg-pink-900/20 text-pink-600 dark:text-pink-400' : '' }}">
                            ...
                            <span class="sidebar-text font-medium">Audio Library</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('admin.app-versions.index') }}" 
                           class="flex items-center space-x-3 p-3 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-teal-50 dark:hover:bg-teal-900/20 hover:text-teal-600 dark:hover:text-teal-400 transition-colors {{ request()->routeIs('admin.app-versions.*') ? 'bg-teal-50 dark:bg-teal-900/20 text-teal-600 dark:text-teal-400' : '' }}">
                            <i class="fas fa-code-branch w-5"></i>
                            <span class="sidebar-text font-medium">App Versions</span>
                        </a>
                    </li>
